...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif data.startswith("m_"): # Move XO
    ...
    # 2. RPS Logic
    elif data.startswith("rj_"): # Join RPS
        rid = parts[1]
    ...
    elif data.startswith("rm_"): # Move RPS
        ...
        if g['m1'] and g['m2']:
            ...
            m1, m2 = g['m1'], g['m2']
            res = "🤝 Draw!"
            if (m1=='R' and m2=='S') or (m1=='S' and m2=='P') or (m1=='P' and m2=='R'): res = f"🏆 {g['n1']} Wins!"
            elif m1 != m2: res = f"🏆 {g['n2']} Wins!"
